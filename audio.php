...
<body>
    ...
    <?php
    $musicFolder = "music"; // Your music folder path
    $audioFiles = glob("$musicFolder/*.{mp3,wav,ogg,m4a}", GLOB_BRACE); // Add more audio extensions here
    ...
    if (!empty($displayedFiles)) {
        foreach ($displayedFiles as $audioFile) {
            ...
            echo "<audio controls preload='metadata'>
                    <source src='$audioFile' type='".mime_content_type($audioFile)."'>
