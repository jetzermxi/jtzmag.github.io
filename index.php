...
<body>
    ...
    <h1 class="foryou-text">For You</h1>
    <div class="container">
        <?php
        ...
        foreach ($data as $row) {
            ...
            if (isset($row['new']) && $row['new'] === true && $count < 12) {
    ...
    <div class="containers">
        ...
        foreach ($data as $row) {
            // Check if the 'new' attribute is true and limit to 10 movies
            if (isset($row['homepage']) && $row['homepage'] === true && $count < 18) {
                $thumbnailUrl = $row['thumbnail']; // Assuming 'thumbnail' is a direct image link
